module.exports = function (RED) {
    ...
    function SWDataNode(config) {
        ...
        this.on('input', function (msg) {
            ...
            options = sethttpOption(url, port, '/webresources/SWMonitorMgmt/getSWData/' + config.deviceid, 'get', username, pwd);
    ...
    RED.nodes.registerType("SWData", SWDataNode);
};