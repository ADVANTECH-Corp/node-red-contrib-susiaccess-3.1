module.exports = function (RED) {
    ...
    function HWDataNode(config) {
        ...
        this.on('input', function (msg) {
            ...
            options = sethttpOption(url, port, '/webresources/HWMonitorMgmt/getHWData/' + config.deviceid,'get', username, pwd);
...
//                    console.log(str);
    ...
    RED.nodes.registerType("HWData", HWDataNode);
};