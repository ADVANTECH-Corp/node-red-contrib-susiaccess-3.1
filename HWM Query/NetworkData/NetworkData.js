module.exports = function (RED) {
    ...
    function NetworkDataNode(config) {
        ...
        this.on('input', function (msg) {
            ...
            options = sethttpOption(url, port, '/webresources/HWMonitorMgmt/getNetworkData/' + config.deviceid,'get', username, pwd);
...
//                    console.log(str);
    ...
    RED.nodes.registerType("NetworkData", NetworkDataNode);
};